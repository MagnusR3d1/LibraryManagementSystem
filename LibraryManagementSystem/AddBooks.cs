            ...
            else
            {
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string path = Path.Combine(@"C:\Users\user\Desktop\LibraryManagementSystem\LibraryManagementSystem\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\" +
